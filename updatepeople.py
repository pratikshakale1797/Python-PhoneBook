...
class Update(Toplevel):
    def __init__(self, person_id):
        ...
        # surname
        self.label_surname = Label(self.bottom, text="Surame", font='arial 15 bold', fg='white', bg='#fcc324')
    ...
    def update_people(self):
        ...
        query="update addressbook set person_name = '{}' ,person_surname = '{}',person_email = '{}' ,person_phone =' {} ',person_address =' {}' " \
              "where person_id = {} ".format(name,surname,email,phone,address,id)
